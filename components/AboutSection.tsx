...
export default function AboutSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="pt-[100px] pb-[75px] px-5 md:pt-[170px] md:pb-[100px] md:px-[72px] lg:pt-[200px] lg:pb-[130px] lg:px-[120px] text-center bg-bg-warm lg:scroll-mt-[84px] overflow-hidden"
    >
